...
{{--                                            {{old("foods[$meal->id]")}}--}}
                                            <label class="checkbox-inline" style="margin-left: 20px">
                                                <input name="foods[]" type="checkbox" value="{{$meal->id}}" {{ old("foods[$meal->id]") === $meal->id ? 'checked' : '' }}>{{$meal->name}}
                                                <input name="amounts[{{$meal->id}}]" type="number" value="{{old("amounts[$meal->id]")}}" >
                                            </label>
                                        @endforeach
                                    @endforeach
                                </div>
