...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo e(voyager_asset('js/datetimepicker/bootstrap-datetimepicker.min.css')); ?>">
    <!-- CSS App -->
...
<script>
    function showUser(user_id, number_of_adults, number_of_children, come_date, leave_date) {
//
        toastr.error(come_date);
        if (number_of_adults == "") {
            number_of_adults = 1;
        }
        ...
        xmlhttp.open("GET", "/getRooms/" + user_id + "/" + number_of_adults + "/" + number_of_children + "/" + come_date + "/" + leave_date, true);
        xmlhttp.send();
    }
</script>
