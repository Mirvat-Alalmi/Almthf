...
<form method="post">
    ...
    <table id="example" class="display my-table" cellspacing="0">
        ...
        <tr>
            <td class="my-td">
                <div class="radio">
                    <label><input type="radio" name="room_id" value="<?php echo e($row['id']); ?>"></label>
                </div>
            </td>
            <td class="my-td"><?php echo e($row['description']); ?></td>
            <td class="my-td"><?php echo e($row['price']); ?></td>
            <td class="my-td"><?php echo e($row['id']); ?></td>
        </tr>
        <?php }
        }?>
        </tbody>
    ...
    <input type="hidden" name="number_of_adults" value="<?php echo e($number_of_adults); ?>">
    <input type="hidden" name="number_of_children" value="<?php echo e($number_of_children); ?>">
    <input type="hidden" name="come_date" value="<?php echo e($come_date); ?>">
    <input type="hidden" name="leave_date" value="<?php echo e($leave_date); ?>">
    <button type="submit" id="button"
            formaction="<?php echo e(route('voyager.books.store')); ?>"
